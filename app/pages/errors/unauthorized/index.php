...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?= BASE_URL ?>/assets/img/error-icon.png" />
    <link rel="stylesheet" type="text/css" href="<?= BASE_URL ?>app/pages/errors/forbidden/style.css">
</head>
...
<body>
    <div class="container">
        ...
        <h1>Accesso no autorizado</h1>
    </div>
</body>

<footer>
    <script src="<?= BASE_URL ?>app/pages/errors/forbidden/script.js"></script>
</footer>
