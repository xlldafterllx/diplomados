        ...
        <div class="row d-flex justify-content-center">
            <div class="col-12 max-w">
                ...
                <div id="alumnos" class="card">
                    ...
                    <div class="card-body" data-container="alumnos">
                        <div data-field-container="alumnos">
                    ...
                    <div class="card-footer text-center">
                        <button type="button" class="btn btn-outline-secondary" data-action="new">Nuevo alumno</button>
                    </div>
                </div>
